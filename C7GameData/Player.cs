...
namespace C7GameData {
	...
	public class Player : IJsonOnDeserialized {
		...
		public void OnDeserialized() {
			// MapUnit does not serialize MapUnit.owner, so it is linked here, since
			// Player stores the source-of-truth copy of MapUnit instances
			this.units.ForEach((MapUnit u) => u.owner = this);
		}
	}
}
