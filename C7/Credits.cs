...
public partial class Credits : Node2D
{
	...
	private void ShowCredits()
	{
		...
		creditsBackground.Texture2D = creditsTexture;
		...
		regularFont.FontData = ResourceLoader.Load<FontFile>("res://Fonts/NotoSans-Regular.ttf");
		boldFont.FontData = ResourceLoader.Load<FontFile>("res://Fonts/NotoSans-Bold.ttf");
		italicFont.FontData = ResourceLoader.Load<FontFile>("res://Fonts/NotoSans-Italic.ttf");
		boldItalicFont.FontData = ResourceLoader.Load<FontFile>("res://Fonts/NotoSans-BoldItalic.ttf");
		regularFont.Size = 14;
		boldFont.Size = 14;
		italicFont.Size = 14;
