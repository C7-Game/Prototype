...
public class MsgStartUnitAnimation : MessageToUI {
	...
	public MsgStartUnitAnimation(MapUnit unit, MapUnit.AnimatedAction action, AutoResetEvent completionEvent, AnimationEnding ending = AnimationEnding.Stop)
	{
...
public class MsgStartEffectAnimation : MessageToUI {
	...
	public MsgStartEffectAnimation(Tile tile, AnimatedEffect effect, AutoResetEvent completionEvent, AnimationEnding ending = AnimationEnding.Stop)
	{
